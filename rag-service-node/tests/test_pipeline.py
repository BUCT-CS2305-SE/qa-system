...
class PipelineTests(unittest.TestCase):
    ...
    def test_artifact_type(self):
        ...
        self.assertEqual(r.status, "ok")
        self.assertEqual(r.intent, "artifact_type")
    ...
    def test_artifact_material(self):
        ...
        self.assertEqual(r.status, "ok")
        self.assertEqual(r.intent, "artifact_material")
    ...
    def test_artifact_description(self):
        ...
        self.assertEqual(r.status, "ok")
        self.assertEqual(r.intent, "artifact_description")
    ...
    def test_recommended_artifacts(self):
        ...
        self.assertEqual(r.status, "ok")
        self.assertEqual(r.intent, "recommended_artifacts")
    ...
    def test_query_summary(self):
        ...
        self.assertEqual(r.status, "ok")
        self.assertEqual(r.summary["total_questions"], 3)
    ...
    def test_multi_hop(self):
        ...
        self.assertEqual(r.status, "ok")
        self.assertEqual(r.intent, "multi_hop")
    ...
    def test_compare_artifacts(self):
        ...
        self.assertEqual(r.status, "ok")
        self.assertEqual(r.intent, "compare_artifacts")
    ...
    def test_artifact_statistics(self):
        ...
        self.assertEqual(r.status, "ok")
        self.assertEqual(r.intent, "artifact_statistics")

    def test_path_query(self):
        r = self.pipeline.handle_question(QAAskRequest(question="女史箴图的流转路径", mode="rule"))
        self.assertEqual(r.status, "ok")
        self.assertEqual(r.intent, "path_query")

    # ── Multi-turn context ───────────────────────────────────────

    def test_context_pronoun_resolution(self):
        sid = "test_session_1"
        r1 = self.pipeline.handle_question(
            QAAskRequest(question="Admonitions Scroll museum?", session_id=sid, mode="rule")
        )
    ...
    def test_topic_switch(self):
        ...
        self.assertEqual(r1.status, "ok")
        r2 = self.pipeline.handle_question(
            QAAskRequest(question="换个话题，清明上河图的作者是谁？", session_id=sid, mode="rule")
        )
        self.assertEqual(r2.status, "ok")
